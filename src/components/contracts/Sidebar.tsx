...
const Sidebar = ({ userRole, onNavigateUsers }: SidebarProps) => {
  return (
    <aside className="w-64 min-h-screen bg-gradient-to-b from-slate-750 via-slate-700 to-slate-750 text-sidebar-foreground p-6 border-r border-sidebar-border">
      <div className="mb-10">
